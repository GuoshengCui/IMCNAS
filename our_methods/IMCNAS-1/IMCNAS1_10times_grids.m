        ...
        for ialpha = 1:length(alpha_list)
            ...
            for ibeta = 1:length(beta_list)
                ...
                for f = 1:num_folds
                    ...
                    [W,H,Ht,Hc] = IMCNAS1_warped_options(X,gnd,G,options);
                ...
                para_IMCNAS1{ialpha,ibeta} = [roundn(mean(ACC)*100,-2),...
                    roundn(mean(NMI)*100,-2),roundn(mean(PUR)*100,-2),...
                    roundn(mean(ARI)*100,-2);
